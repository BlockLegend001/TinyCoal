...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        shapeless(RecipeCategory.MISC, ModItem.TINY_COAL.get(), 8)
                ...
                .save(this.output, String.valueOf(Identifier.fromNamespaceAndPath("tinycoal", "tiny_coal_from_coal")));

        shapeless(RecipeCategory.MISC, ModItem.TINY_CHARCOAL.get(), 8)
                .requires(Items.CHARCOAL)
                .unlockedBy("has_charcoal", has(Items.CHARCOAL))
                .save(this.output, String.valueOf(Identifier.fromNamespaceAndPath("tinycoal", "tiny_charcoal_from_charcoal")));
        ...
        shaped(RecipeCategory.MISC, Items.COAL)
                ...
                .save(this.output, String.valueOf(Identifier.fromNamespaceAndPath("tinycoal", "coal_from_tiny_coal")));
        ...
        shaped(RecipeCategory.MISC, Items.CHARCOAL)
                ...
                .save(this.output, String.valueOf(Identifier.fromNamespaceAndPath("tinycoal", "charcoal_from_tiny_charcoal")));
    }
